...
import { HeaderBottom, HeaderContainer, HeaderContent, HeaderLink, HeaderTop } from "./header.styles";
...
const Header = () => {
    ...
    const topBrands = [
        {
            name: 'Paris',
            image: 'https://easycl.vtexassets.com/_v/public/assets/v1/published/easycl.custom-blocks@4.0.21/public/react/413f160b9c794687fdf789913dd18663.svg',
            link: 'https://www.paris.cl'
        },
        {
            name: 'Jumbo',
            image: 'https://easycl.vtexassets.com/_v/public/assets/v1/published/easycl.custom-blocks@4.0.21/public/react/4a7dba45da83e507aa4c3480aaf4eb06.svg',
            link: 'https://www.jumbo.cl'
        },
        {
            name: 'Santa Isabel',
            image: 'https://easycl.vtexassets.com/_v/public/assets/v1/published/easycl.custom-blocks@4.0.21/public/react/be6020963789abdcaf77e3778631e150.svg',
    ...
    const logoURL = 'https://easycl.vtexassets.com/assets/vtex.file-manager-graphql/images/97740859-8d6b-4562-ad02-d6fd37c14e32___bab6e437e21af76315174bd3b460d74a.svg';
    ...
    return(
        <HeaderContainer>
            <HeaderTop>
                {
                    topBrands.map(brand => (
                        <HeaderLink href={brand.link} target="_blank" key={brand.name} image={brand.image}>
            ...
            <HeaderContent>
                <nav>
                    <div className="logo">
                        <Image src={logoURL} alt="Easy" width={50} height={50} title='Easy Home' priority />
                    </div>
            ...
            <HeaderBottom>
                <div><a href="/tiendas">Horarios y tiendas</a></div>
                <div>
                    <span>Todo <strong>Easy.cl</strong> hasta en <strong>6 cuotas sin interés</strong></span>
                    <Image src="https://easycl.vteximg.com.br/arquivos/medios-pago2.svg" width="113" height="21" alt=""/>
                </div>
            </HeaderBottom>
        </HeaderContainer>
    )
